...
function dataListInit(data){
	...
	if(data.list){
		for(var k in data.list){
			...
			if(type == "2"){
				$('#secondPage .answers').append('<div class="checkbox"><label><input type="checkbox" class="secondQuestion" value="'+data.list[k].caseId+'">'+data.list[k].caseName+'</label></div>');
			}
			if(type == "3"){
				$('#thirdPage .answers').append('<div class="checkbox"><label><input type="checkbox" class="thirdQuestion" value="'+data.list[k].caseId+'">'+data.list[k].caseName+'</label></div>');
			}
		}
	}
